...
import 'package:ny_times_app/src/features/ny_times_articles/data/data_sources/ny_times_articles_shared_prefs.dart';
...
class NyTimesArticlesRepositoryImpl extends NyTimesArticlesRepository {
  ...
  @override
  Future<Either<Failure, List<NyTimesArticlesModel>>> getNyTimesData(NyTimesArticlesParams params) async {
    try {
